...
public:
  ...
  from the dataset; populates the two-dimensional std::vector<std::vector<Color>> 
  with Color representation of each elevation datum. 
  ...
  */
  ...
  with translated Color representation from each read elevation datum. 
  Sets width_ and height_ appropriately.
  */
